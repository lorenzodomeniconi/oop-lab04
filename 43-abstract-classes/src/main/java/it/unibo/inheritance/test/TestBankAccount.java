...
public class TestBankAccount {
    ...
    public static void main(final String[] args) {
         ...
         */
        final BankAccount restricted = new RestrictedBankAccount(aBianchi, INTIAL_AMOUNT);
        final BankAccount extendedStrict = new ExtendedStrictBankAccount(aRossi, INTIAL_AMOUNT);
        final BankAccount simpleBankAccount = new SimpleBankAccount(aBianchi, INTIAL_AMOUNT);
        final BankAccount classicBankAccount = new ClassicBankAccount(aRossi, INTIAL_AMOUNT);
